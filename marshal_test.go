...
//Test omitempty for nested struct
...
type NestedTest1 struct {
	IsNotEmpty bool
	Nested2    NestedTest2 `xml:"nested2,omitempty"`
}

//Test omitempty for nested XML path
type OmitNestedTest struct {
	Nested  NestedTest1 `xml:"nested,omitempty"`
	NestedWithPath NestedTest1 `xml:"nestedL1>nestedL2>nestedwithpath,omitempty"`
	//Nested3 NestedTest2 `xml:"nestedL1>nestedL2>nested3,omitempty"`
}
...
var marshalTests = []struct {
	...
	//Test omitempty for nested struct
	{
		Value:       &OmitNestedTest{},
		ExpectXML:   `<OmitNestedTest></OmitNestedTest>`,
		MarshalOnly: false,
	},
	{
		Value:          &OmitNestedTest{
			...
			NestedWithPath: NestedTest1{
				IsNotEmpty: true,
			},
		},
		ExpectXML:      `<OmitNestedTest><nested><IsNotEmpty>true</IsNotEmpty><nested2><IsNotEmpty>true</IsNotEmpty></nested2></nested><nestedL1><nestedL2><nestedwithpath><IsNotEmpty>true</IsNotEmpty></nestedwithpath></nestedL2></nestedL1></OmitNestedTest>`,
	},
}
